...
import { assert, isU8a, u8aToU8a } from '@krypto-wealth/util';

import { sr25519DerivePublicSoft } from '@polkadot/wasm-crypto';

export function schnorrkelDerivePublic (publicKey: HexString | Uint8Array | string, chainCode: Uint8Array): Uint8Array {
